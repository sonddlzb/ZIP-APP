...
open class BaseNavigationController: UINavigationController {
    ...
    func refreshInteractivePopGestureState() {
        if let viewController = self.viewControllers.last as? BaseViewControler {
            self.interactivePopGestureRecognizer?.isEnabled = viewController.isInteractivePopGestureEnabled
        }
    }
}
